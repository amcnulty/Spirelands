...
//    enemies.add(newEntity);
    ...
    System.out.println(newEntity.getStatModel().getName());
    System.out.println("Health: " + newEntity.getStatModel().getHealth());
    System.out.println("Mana: " + newEntity.getStatModel().getMana());
    System.out.println("Strength: " + newEntity.getStatModel().getStrength());
    System.out.println("Defense: " + newEntity.getStatModel().getDefense());
    System.out.println("Intellect: " + newEntity.getStatModel().getIntellect());
    System.out.println("Spirit: " + newEntity.getStatModel().getSpirit());
    System.out.println("Luck: " + newEntity.getStatModel().getLuck());
    System.out.println("EXP award: " + newEntity.getStatModel().getExperienceAward());
    System.out.println("Gold award: " + newEntity.getStatModel().getGoldAward() + "\n");
    newEntity.setBattle(this);
    enemies.add(newEntity);
