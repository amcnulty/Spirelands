...
public class SettingsView extends TitleView {
  ...
  private void setupFonts() {
    ...
    for (int i = 0; i < lines.size(); i++) {
      ...
      info.setY(90 + i * 7);
      info.setColor(new Color(GameColors.RED));
  ...
  private void setupCheckButtons() {
    resolutionButtons.add(new CheckButton(checkboxX, 130, "1024x576", () -> resetButtons()));
    resolutionButtons.add(new CheckButton(checkboxX, 142, "1152x648", () -> resetButtons()));
    resolutionButtons.add(new CheckButton(checkboxX, 154, "1280x720", () -> resetButtons()));
    resolutionButtons.add(new CheckButton(checkboxX, 166, "1366x768", () -> resetButtons()));
    resolutionButtons.add(new CheckButton(checkboxX, 178, "1600x900", () -> resetButtons()));
    resolutionButtons.add(new CheckButton(checkboxX, 190, "1920x1080", () -> resetButtons()));
  }
  
  private void setupCursorButtons() {
    cursorButtons.add(new CheckButton(cursorCheckX, 90, "hand cursor", () -> resetCursorButtons()));
    cursorButtons.add(new CheckButton(cursorCheckX, 120, "white cursor", () -> resetCursorButtons()));
    cursorButtons.add(new CheckButton(cursorCheckX, 150, "fantasy cursor", () -> resetCursorButtons()));
